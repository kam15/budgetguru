	...
	public void onCreate(Bundle savedInstanceState) {
		...
		detail_list.setOnItemClickListener(new OnItemClickListener(){
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
            	...
            	//detail_list.getItemAtPosition(position);
            	if (selectpos == -1) {
				...
				ad.setPositiveButton(button1String,
						new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog,
								...
								DatabaseHandler db = new DatabaseHandler(getApplicationContext());
								db.delete(cat,Integer.parseInt(amt),des,date);
								List<Finance> list=db.getRecords(date);
								...
								/****_____Something i dint understand here..Ask bhakti*/
								//Intent i=new Intent(this,LowerTodaysExpenses.class);
								//i.putExtra(LowerTodaysExpenses.DATE, date);
								//startActivity(i);
