		...
		public void onItemClick(AdapterView parent, View view, int position,
			...
			case 1:
				Toast.makeText(getApplicationContext(),
						"Initial amount clicked", Toast.LENGTH_LONG)
						.show();
				selectItem(1);
				break;
			...
			case 3:
				/*
				 * Toast.makeText(getApplicationContext(),
				 * "View Specified Date Expenses clicked",
				 * Toast.LENGTH_LONG).show();
				 */
				flag = 0;
				LayoutInflater inflater = (LayoutInflater) view.getContext()
						.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
				View npView = inflater.inflate(R.layout.dialog_specificdate,
						null);
			...
			case 6:
				Toast.makeText(getApplicationContext(), "Lent/Borrowed clicked",
						Toast.LENGTH_LONG).show();
				Intent i2 = new Intent();
				i2.setClass(getApplicationContext(), ForgetMeNot.class);
				startActivity(i2);
...
//@SuppressLint("newapi")
	...
	if(android.os.Build.VERSION.SDK_INT>=11)
	{
		...
		if (position == 2) {
			...
			/*
			 * DatePicker dp = new DatePicker(getApplicationContext()); date =
			 * dp.getDayOfMonth() + "/" + dp.getMonth() + "/" + dp.getYear();
			 */
			date = d.get(Calendar.DAY_OF_MONTH) + "/" + d.get(Calendar.MONTH)
					+ "/" + d.get(Calendar.YEAR);
			 ...
			 * dialog.setTitle("Select Specific Date"); // final Dialog dialog =
			 * new Dialog(mContext); //
			 * dialog.setContentView(R.layout.dialog_specificmonth);
			 * 
			 * LayoutInflater inflater = (LayoutInflater)
			 * getApplicationContext()
			 * .getSystemService(Context.LAYOUT_INFLATER_SERVICE); View npView =
			 * inflater.inflate(R.layout.dialog_specificdate, null);
			 */
			Fragment fragment = new TodaysExpenses();
			Bundle args = new Bundle();
			args.putString(TodaysExpenses.ARG_OS, "" + position);
