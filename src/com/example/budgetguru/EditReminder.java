...
public class EditReminder extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		while (!c1.isAfterLast()) {
			...
			category_spinner
					.setSelection(spinadapt.getPosition(c1.getString(1)));
			type_spinner.setSelection(typeadapt.getPosition(c1.getString(2)));
			date_picker.init(date_picker.getYear(), date_picker.getMonth(),
					date_picker.getDayOfMonth(), null);
		...
		submit_btn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (alarmdate.trim().equals("")) {
					Toast t = Toast.makeText(EditReminder.this,
							"Please select the date for the reminder",
							Toast.LENGTH_LONG);
					t.show();
				} else
				...
				if (alarmtime.trim().equals("")) {
					Toast t = Toast.makeText(EditReminder.this,
							"Please select the time for the reminder",
							Toast.LENGTH_LONG);
					t.show();
				}
				...
				finish();
				Intent show_list = new Intent(getApplicationContext(),
						ForgetMeNot.class);
		...
		reset_btn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				date_picker.init(today.get(Calendar.YEAR),
