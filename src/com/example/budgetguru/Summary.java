...
public class Summary extends Activity implements SimpleGestureListener {
	...
	private int amount, cash = 0, food_amount = 0, travel_amount = 0,
			entertain_amount = 0, clothing_amount = 0, bill_amount = 0,
			medical_amount = 0, missing_amount = 0, other_amount = 0;
	...
	public void onSwipe(int direction) {
		...
		case SimpleGestureFilter.SWIPE_RIGHT:
			str = "Swipe Rightt";
			Intent i2 = new Intent(this, PieChartActivity.class);
			startActivity(i2);
			break;
		}
