		...
		add.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (amt.getText().toString().equals(""))
					...
					db.addTrans(new Finance("", 0, "", "", Integer.parseInt(amt
							.getText().toString())));

					Toast.makeText(getApplicationContext(),
							"Balance=" + db.getBal(), Toast.LENGTH_LONG).show();
					db.close();
					Intent page = new Intent(getApplicationContext(),
							LowerMain.class);
					startActivity(page);
				}
			}
		...
		deduct.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (amt.getText().toString().equals(""))
					...
					DatabaseHandler db = new DatabaseHandler(
							getApplicationContext());
					db.addTrans(new Finance("", Integer.parseInt(amt.getText()
							.toString()), "", ""));
					 db.addTrans(new
					 Finance("6/11/2013",Integer.parseInt(amt.getText().toString()),
					 "", ""));
