...
public class SQLiteHelper extends SQLiteOpenHelper {
	...
	public static final String CREATE_TABLE = "create table " + DB_TABLE + "("
			+ DB_ATTR1 + " text," + DB_ATTR2 + " text," + DB_ATTR3 + " text,"
			+ DB_ATTR4 + " date default CURRENT_DATE," + DB_ATTR5
			+ " time default CURRENT_TIMESTAMP," + DB_ATTR6 + " date,"
			+ DB_ATTR7 + " time)";

	public static final String DB_TABLE2 = "Categories";
	public static final String DB_ATTR = "Category";
	public static final String CREATE_TABLE2 = "create table " + DB_TABLE2
			+ "(" + DB_ATTR + " text)";
